...
get_jobs                  Get a list of all jobs for a Spark application. A...
get_slowest_jobs          Get the N slowest jobs for a Spark application. R...
...
get_slowest_sql_queries   Get a summary of the top N slowest SQL queries fo...
